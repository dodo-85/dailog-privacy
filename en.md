...
- **Deletion method**: Upon account deletion, all user data (blocks, labels, goals, settings) stored in Firebase Authentication and Firestore is immediately deleted
- **Data requests**: Users may request deletion at any time via email
...
## 5. Data Processing and International Transfer
...
**How to exercise**: Contact us via email below. Requests will be processed within 10 days.
...
We will notify users of any changes to this policy at least 7 days before the effective date through in-app notifications.
